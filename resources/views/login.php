        ...
        <main id="content-wrapper" class="content-wrapper container d-flex vh-100 m-0 mx-auto">
            <div class="sign-wrapper mx-auto py-4 px-5 align-self-center">
                ...
                <?php if (isset($_SESSION['input_error'])) { ?>
                    <div class="text-danger text-center mb-3" role="alert">Email atau password yang kamu masukkan salah.<br/>Silakan coba lagi.</div>
                <?php  } ?>
                <form action="../models/m_auth.php" method = 'post' class="sign-form mx-3">
                    ...
                    <button name = 'login' value = 'login' type="submit" class="btn btn-primary w-100 mt-4">Masuk</button>
                    <a href="register.php" type="button" class="btn btn-link w-100 mt-3">Daftar</a>
                </form>
            </div>
        </main>
